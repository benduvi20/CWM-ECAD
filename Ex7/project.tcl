...
create_ip -name blk_mem_gen -vendor xilinx.com -library ip -version 8.4 -module_name mem_blk
set_property -dict [list CONFIG.Component_Name {mem_blk} CONFIG.Write_Width_A {6} CONFIG.Write_Depth_A {64} CONFIG.Read_Width_A {6} CONFIG.Write_Width_B {6} CONFIG.Read_Width_B {6} CONFIG.Load_Init_File {true} CONFIG.Coe_File {/home/centos/CWM-ECAD/Ex7/my_init.coe}] [get_ips mem_blk]
